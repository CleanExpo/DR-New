...
export const metadata: Metadata = {
  ...
  description: 'Professional water damage restoration Cleveland Brisbane. Coastal property specialists, storm surge experts, salt damage remediation. Master Restorer certified for Moreton Bay waterfront homes.',
