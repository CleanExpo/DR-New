        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-centre text-gray-900 mb-8">
              ...
              <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                ...
                <p className="text-lg leading-relaxed">
                  ...
                  Queenslander homes that demand specialised restoration techniques, our team understands the specific needs of
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-centre gap-3">
                ...
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Ipswich is home to beautiful heritage Queenslander homes and historic buildings that require specialised
                ...
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Ipswich CBD, Riverlink Shopping Centre, and industrial estates require immediate disaster response to minimise
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-8 bg-blue-50 rounded-lg p-6 text-centre">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white/10 backdrop-blur rounded-lg p-6">
                  ...
                  <p className="text-blue-100 leading-relaxed">
                    Queenslander homes and historic buildings require specialised restoration techniques. Our team
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="bg-blue-50 rounded-lg p-6 text-centre">
