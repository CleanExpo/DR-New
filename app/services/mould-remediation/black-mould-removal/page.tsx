...
export default function BlackMouldRemovalBrisbanePage() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/mould-remediation/black-mould-removal',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for black mould removal brisbane with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
