                ...
                <dialogue>
                  ...
                  <DialogContent>
                    ...
                    <div className="space-y-4 pt-4">
                      <a href="#contact-form" className="flex items-centre justify-centre gap-2 bg-green-700 text-white px-6 py-3 rounded-lg font-bold hover:bg-green-800">
              ...
              {[
                ...
                <div key={item.step} className="flex gap-6">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-green-700 text-white rounded-full flex items-centre justify-centre font-bold">
                      {item.step}
                    </div>
                  </div>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="container mx-auto px-4 text-centre">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-centre">
            <a href="#contact-form" className="bg-white text-green-600 px-8 py-4 rounded-lg font-bold hover:bg-gray-100 flex items-centre justify-centre gap-2">
              <MessageSquare className="h-5 w-5" />
              Use Our Online Form'
            </a>
