...
export default function EmergencyStructuralDryingPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/emergency-services/emergency-drying',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for emergency structural drying with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
