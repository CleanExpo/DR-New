...
export default function EmergencyServicesPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Our emergency response teams are available 24/7/365 with average response times of 30-60 minutes in metro areas and 2-4 hours in regional Queensland. We prioritise based on severity and safety risks.'
    },
    {
      question: 'Do you work directly with insurance companies?',
      answer: 'Yes, we\'re approved contractors for all major insurers. We can manage your entire claim process, provide detailed documentation, and bill insurers directly to minimise your stress during emergencies.'
    },
    {
                ...
                <div className="p-6">
                  ...
                  <ul className="space-y-2">
                    {type.situations.map((situation, idx) => (
                      <li key={idx} className="flex items-centre gap-2 text-sm text-gray-200">
