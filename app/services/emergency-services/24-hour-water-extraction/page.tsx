...
export default function TwentyFourHourWaterExtractionPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/emergency-services/24-hour-water-extraction',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for 24 hour water extraction with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
