            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <Card className="p-8">
                ...
                <p className="text-lg mb-4">
                  ...
                  riverside areas. Our team specialises in both large-scale industrial and
              ...
              <Card className="p-8">
                ...
                <p className="text-lg mb-4">
                  Wacol's industrial facilities and flood history require specialised
