  ...
  return (
    ...
    >
      ...
      <section className="mb-16">
        ...
        {/* Storm Warning Alert */}
        <div className="bg-gradient-to-r from-blue-700 to-red-500 rounded-xl p-6 text-white mb-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center px-6 py-3 bg-blue-700 text-white rounded-lg font-medium hover:bg-blue-800 transition-colours"
            >
      ...
      {/* Call to Action */}
      <section className="bg-gradient-to-r from-blue-700 to-red-600 rounded-2xl p-8 text-center text-white">
