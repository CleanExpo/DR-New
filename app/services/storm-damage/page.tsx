...
export default function StormDamagePage() {
  return (
    ...
    >
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <p className="text-neutral-700 mb-6">
              ...
              and water extraction to minimise secondary damage.
            </p>
          </div>
      ...
      {/* Call to Action */}
      <section className="bg-gradient-to-r from-blue-600 to-red-600 rounded-2xl p-8 text-centre text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-centre">
          <a
            href="/contact"
            className="inline-flex items-centre justify-centre px-8 py-4 bg-white text-blue-700 rounded-lg font-bold text-lg hover:bg-blue-50 transition-colours"
          >
