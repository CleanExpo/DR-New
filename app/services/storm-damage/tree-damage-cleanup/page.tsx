...
export default function FallenTreeDamageCleanupPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/storm-damage/tree-damage-cleanup',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for fallen tree damage cleanup with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
