  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for cyclone damage restoration with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
