...
export default function BlackWaterContaminationPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/sewage-cleanup/black-water-cleanup',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for black water contamination with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
