...
const faqs = [
  {
    ...
    answer: "We provide 24/7 emergency response with technicians typically arriving within 1-2 hours in major metropolitan areas. Our rapid response helps minimise secondary damage and begins the restoration process immediately."
  },
  {
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-neutral-700 text-sm">We can bill your insurance company directly to minimise out-of-pocket costs</p>
                </div>
              </div>
