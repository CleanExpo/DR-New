...
export default function ShowerLeakWaterDamagePage() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/water-damage/shower-leaks',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for shower leak water damage with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
