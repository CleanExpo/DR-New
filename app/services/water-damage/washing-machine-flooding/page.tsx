  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for washing machine flood damage with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
