...
const faqs = [
  ...
  },
  {
    ...
    answer: "Our technicians are trained to work with compassion and discretion during difficult times. We can recommend grief counseling resources and work quietly and respectfully to minimise additional trauma for families."
  }
];
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-neutral-200 rounded-xl p-6 shadow-sm text-centre">
            ...
            <p className="text-neutral-700 text-sm">
              ...
              service to minimise attention and protect dignity.
            </p>
          </div>
