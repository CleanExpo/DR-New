...
export default function BodilyFluidCleanupPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/biohazard-cleaning/bodily-fluids',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for bodily fluid cleanup with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
