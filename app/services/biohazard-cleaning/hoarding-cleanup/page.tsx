...
export const metadata: Metadata = {
  ...
  description: 'Professional hoarding cleanup in Brisbane, Ipswich, Logan. Compassionate, discreet extreme cleaning. Phill McGurk - IICRC Master Restorer, Xactimate Master, Hazmat Licensed, Asbestos Assessor.',
