...
export default function HoardingCleanupClient() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/biohazard-cleaning/hoarding-cleanup',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for hoarding cleanup services with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
