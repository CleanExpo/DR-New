...
export const metadata: Metadata = generateServiceSEO({
  ...
  description: 'Compassionate death cleanup in Brisbane, Ipswich, Logan. Unattended death, decomposition removal. Phill McGurk - IICRC Master Restorer, Xactimate Master, Hazmat Licensed, Asbestos Assessor.',
  keywords: [
