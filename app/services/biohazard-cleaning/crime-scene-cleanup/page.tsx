...
export const metadata: Metadata = generateServiceSEO({
  ...
  description: 'Professional crime scene cleanup in Brisbane, Ipswich, Logan. Discreet, trauma-informed biohazard removal. Phill McGurk - IICRC Master Restorer, Xactimate Master, Hazmat Licensed, Asbestos Assessor.',
  keywords: [
