...
export default function SchoolWaterDamageCleanupPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/commercial-services/school-water-damage',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for school water damage cleanup with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
