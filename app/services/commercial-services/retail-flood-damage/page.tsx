...
export default function RetailStoreFloodRecoveryPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/commercial-services/retail-flood-damage',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for retail store flood recovery with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
