...
export default function HotelFloodRestorationPage() {
  ...
  const businessInfo = {
    ...
    url: 'https://dr-new-ten.vercel.app/services/commercial-services/hotel-flood-recovery',
  ...
  const faqs = [
    {
      ...
      answer: 'We offer 24/7 emergency response for hotel flood restoration with teams typically arriving within 2 hours in metro areas. Our rapid response helps minimise damage and reduce restoration costs.'
    },
    {
