...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section ONLY */}
      <section className="relative min-h-[600px] flex items-centre justify-centre text-white">
        ...
        <div className="relative z-10 container mx-auto px-6 text-centre">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-centre">
            <Link
              href="tel:1300309361"
              className="inline-flex items-centre justify-centre px-10 py-5 bg-red-600 text-white text-lg font-bold rounded-lg hover:bg-red-700 transition-colors shadow-lg hover:shadow-xl transform hover:scale-105"
            >
      ...
      <section className="bg-gradient-to-r from-blue-900 to-blue-800 py-6">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 text-white text-centre">
            ...
            <div className="flex flex-col items-centre md:col-span-1 col-span-2">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 bg-red-600 text-white rounded-lg p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-centre">
                <Link
                  href="tel:1300309361"
                  className="inline-flex items-centre justify-centre px-6 py-3 bg-white text-red-600 font-bold rounded hover:bg-gray-100 transition-colors"
                >
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-centre justify-centre px-6 py-3 bg-red-700 text-white font-bold rounded hover:bg-red-800 transition-colors"
                >
        ...
        <div className="container mx-auto px-6">
          <div className="text-centre mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Premium Brisbane Suburbs We specialise In
            </h2>
            <p className="text-xl text-gray-600">
              specialised restoration for Brisbane's most exclusive neighborhoods
            </p>
          </div>
          ...
          <div className="text-centre mt-12">
            <Link
              href="/brisbane"
              className="inline-flex items-centre justify-centre px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors"
            >
            ...
            <div className="grid md:grid-cols-2 gap-12 items-centre">
              <div className="order-2 md:order-1">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4">
                  ...
                  <Link
                    href="tel:1300309361"
                    className="inline-flex items-centre justify-centre px-8 py-4 bg-white hover:bg-gray-100 text-blue-900 font-bold rounded-lg transition-colors"
                  >
                    <Phone className="w-5 h-5 mr-2" />
                    Call 1300 309 361
                  </Link>
