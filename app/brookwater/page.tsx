...
export const metadata: Metadata = {
  ...
  description: 'Professional water damage restoration Brookwater Springfield. Championship golf estate specialists, new construction experts, smart home system protection. Master Restorer certified for luxury properties.',
...
const luxuryServices = [
  {
    ...
    description: 'Specialized restoration for Brookwater\'s Greg Norman championship golf course properties with understanding of premium landscaping, irrigation coordination, and luxury finishes.',
    icon: Trophy,
  ...
  },
  {
    ...
    description: 'Specialized care for luxury finishes including imported tiles, engineered timber, designer fixtures, and architectural elements unique to Brookwater estates.',
    icon: Award,
...
const brookwaterRisks = [
  ...
  },
  {
    ...
    response: 'Emergency electrical isolation, smart system protection, automation recovery, technology assessment, specialized electrical contractors',
...
const brookwaterFeatures = [
  ...
  'Greg Norman golf course property specialized protocols',
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <p className="text-xl mb-8 leading-relaxed max-w-4xl mx-auto">
                ...
                <strong> Master Restorer Phill McGurk</strong> - specialized in Greg Norman course homes, new construction
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                Specialized restoration services across Brookwater's luxury communities,
        ...
        <section className="py-16 bg-amber-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                Specialized services designed for Brookwater's championship golf estates
        ...
        <section className="py-16 bg-red-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-4xl mx-auto">
              ...
              Our Master Restorer team provides rapid luxury property restoration and specialized care to preserve
