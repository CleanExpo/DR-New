...
export const metadata: Metadata = {
  ...
  description: 'Professional water damage restoration Brookwater Springfield. Championship golf estate specialists, new construction experts, smart home system protection. Phill McGurk - IICRC Master Restorer, RAI Master Restorer, Xactimate Master, Hazmat Licensed, Asbestos Assessor.',
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-centre">
              ...
              <p className="text-xl mb-8 leading-relaxed max-w-4xl mx-auto">
                ...
                <strong>Phill McGurk - IICRC & RAI Master Restorer</strong> - Xactimate Master, Hazmat Licensed, Asbestos Assessor - specialised in Greg Norman course homes, new construction
