...
const professionalServices = [
  ...
  },
  {
    ...
    description: 'Specialized restoration of climate-controlled wine cellars, collection preservation, and temperature monitoring systems.',
    icon: Droplets,
...
const luxuryFeatures = [
  ...
  'Home theater and media room recovery',
        ...
        <section className="relative bg-gradient-to-r from-green-900 via-blue-900 to-purple-900 text-white py-20">
          <div className="container mx-auto px-4">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <Link
                href="tel:1300309361"
                className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-lg font-bold text-xl transition-colors inline-flex items-center gap-3 mr-4"
              >
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                Specialized restoration services for the region's most prestigious properties,
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                Specialized restoration protocols for medical professionals, legal practitioners,
