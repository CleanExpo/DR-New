        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p>
                Our office is located at 4/17 Tile St, Wacol, QLD 4076, Australia. For privacy concerns, please contact us at <a href="mailto:info@disasterrecovery.com.au" className="text-blue-600 hover:text-blue-700">info@disasterrecovery.com.au</a> or call 1300 309 361.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                To exercise these rights, please contact us at <a href="mailto:info@disasterrecovery.com.au" className="text-blue-600 hover:text-blue-700">info@disasterrecovery.com.au</a>.
              </p>
            </section>
