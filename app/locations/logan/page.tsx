...
export default function LoganRegionalPage() {
  const locations = [
  {
    "name": "Logan",
    "slug": "logan"
  ...
  return (
    <div className="min-h-screen">
      <FluidEmergencyBanner
        phone="1300 309 361"
        message="24/7 Emergency Restoration Logan - Master Restorer Response"
        sticky
      />
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6">
              Logan Emergency Restoration Services
            </h1>
            <p className="text-lg md:text-xl lg:text-2xl mb-6 md:mb-8 text-blue-200">
              Professional disaster recovery serving Logan
            </p>
      ...
      <section className="py-12 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12">
            Emergency Services Across Logan
          </h2>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6">
              Need Emergency Restoration in Logan?
            </h2>
            <p className="text-lg md:text-xl mb-6 md:mb-8">
              Available 24/7 for immediate assistance throughout all Logan areas
            </p>
            <FluidCTA
              text="Call 1300 309 361 Now"
              href="tel:1300309361"
