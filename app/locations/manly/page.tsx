...
export default function ManlyPage() {
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "@id": "https://disasterrecovery.com.au/locations/manly",
    "name": "Disaster Recovery - Manly",
    "image": "https://disasterrecovery.com.au/images/hero/disaster-recovery-services.jpg",
    "telephone": "1300 309 361",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Servicing Manly",
      ...
      <main className="min-h-screen">
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Water Damage Restoration Manly Brisbane
            </h1>
            <p className="text-xl mb-8">
              Waterfront homes, marina properties, coastal businesses • 24/7 Emergency Response • Insurance Approved
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold mb-6">
                  Manly's Trusted Water Damage Specialists
                </h2>
                <p className="text-lg mb-4">
                  Our expert team provides rapid water damage restoration services throughout Manly.
                  With extensive experience in waterfront homes, marina properties, coastal businesses, we understand the unique challenges
                  of properties in Manly 4179.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">✓</span>
                    <span>Rapid response to Manly emergencies</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">✓</span>
                    <span>Local knowledge of Manly property types</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">✓</span>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold mb-8 text-center">
              Why Manly Properties Choose Disaster Recovery
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-xl font-bold mb-3">Local Expertise</h3>
                <p>
                  Deep understanding of Manly's unique property characteristics,
                  from waterfront homes, marina properties, coastal businesses.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-xl font-bold mb-3">Fast Response</h3>
                <p>
                  Our emergency teams can reach Manly quickly,
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">
              Manly Emergency Water Damage Response
            </h2>
            <p className="text-xl mb-8">
              Servicing all of Manly 4179 with rapid 24/7 emergency response.
