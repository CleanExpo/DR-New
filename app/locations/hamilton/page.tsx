        ...
        <section className="relative py-24 text-white overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              alt="Hamilton Brisbane emergency water damage restoration services - IICRC Master Restorer Phill McGurk providing 24/7 restoration for Hamilton luxury riverside properties and prestige homes"
              fill
