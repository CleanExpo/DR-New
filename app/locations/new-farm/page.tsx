...
const schemaData = LOCATION_SCHEMAS.newFarm();
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="container mx-auto px-4 max-w-6xl relative z-10">
            <div className="text-center">
              ...
              <p className="text-lg mb-8 text-gray-200">
                Serving New Farm riverside properties with IICRC-certified emergency restoration
              </p>
        ...
        {/* Services for New Farm */}
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-4 text-gray-900">
              Emergency Restoration Services in New Farm
            </h2>
            <p className="text-center text-gray-600 mb-12 text-lg">
              Specialized disaster recovery for New Farm riverside properties and heritage homes
            </p>
        ...
        {/* Why Choose Us - New Farm Specific */}
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-12 text-gray-900">
              Why New Farm Property Owners Choose Us
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-red-50 to-white rounded-lg p-8 border border-red-200">
                <div className="text-5xl mb-4">⚡</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  30-Minute New Farm Response
                </h3>
                <p className="text-gray-700">
                  Located near New Farm with dedicated emergency dispatch. Average response time under 30 minutes
                  to minimize damage and protect your riverside property investment.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-white rounded-lg p-8 border border-green-200">
                <div className="text-5xl mb-4">💼</div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  Heritage & Modern Property Specialists
                </h3>
                <p className="text-gray-700">
                  Extensive experience with New Farm heritage Queenslanders and modern riverside apartments.
                  Specialized techniques for heritage features, high-value renovations, and premium finishes.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-br from-red-600 via-red-700 to-red-900 text-white">
          <div className="container mx-auto px-4 text-center max-w-4xl">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              New Farm Emergency? Call Now
            </h2>
            <p className="text-xl mb-8 text-red-100">
              Available 24/7 for immediate emergency restoration assistance to New Farm properties
            </p>
