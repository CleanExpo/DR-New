...
export const metadata: Metadata = {
  ...
  description: 'Professional water damage restoration Hamilton Brisbane. Riverfront mansion specialists, executive property experts, CEO residence emergency response. Phill McGurk - IICRC Master Restorer, Xactimate Master, Hazmat Licensed, Asbestos Assessor.',
