      ...
      <div className="min-h-screen bg-white">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-centre">
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link
                    href="tel:1300309361"
                    className="inline-flex items-centre justify-centre px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg transition-colors"
                  >
              ...
              <div className="lg:text-right">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-centre space-x-3">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-centre mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                ...
                from the CBD to the suburbs, with specialised expertise in flood-prone areas.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <Link
                  ...
                  className="inline-flex items-centre mt-4 text-blue-600 hover:text-blue-800"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <p className="text-gray-600 mb-4">
                  specialised flood restoration for Brisbane River areas.
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <p className="text-gray-600 mb-4">
                  ...
                  specialised cleaning and decontamination.
                </p>
                <Link
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="prose max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <h3 className="text-xl font-semibold text-blue-900 mb-3">24/7 Dispatch centre</h3>
                  <p className="text-gray-700">
                    Our Wacol-based dispatch centre operates around the clock, ensuring immediate response to disaster recovery emergencies throughout Brisbane. Every call is answered by trained professionals who can deploy our IICRC certified technicians within minutes of your emergency.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border border-blue-100">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-centre justify-centre mr-4">
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-100">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-amber-100 rounded-lg flex items-centre justify-centre mr-4">
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 border border-green-100">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-green-100 rounded-lg flex items-centre justify-centre mr-4">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-xl p-6 border border-purple-100">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-centre justify-centre mr-4">
              ...
              <div className="bg-gradient-to-br from-red-50 to-rose-50 rounded-xl p-6 border border-red-100">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-red-100 rounded-lg flex items-centre justify-centre mr-4">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-slate-50 rounded-xl p-6 border border-gray-200">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-centre justify-centre mr-4">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-xl shadow-sm p-6 border-l-4 border-yellow-400">
                ...
                <Link
                  href="tel:1300309361"
                  className="inline-flex items-centre justify-centre w-full px-6 py-3 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold rounded-lg transition-colors"
                >
                  <Phone className="mr-2 h-5 w-5" />
                  Call 1300 309 361
                </Link>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-centre mb-12">
              ...
              <p className="text-xl text-gray-600">
                specialised restoration services for Brisbane's most exclusive neighborhoods
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="flex items-centre gap-3 mb-4">
                  <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-centre justify-centre group-hover:bg-blue-200 transition-colors">
                ...
                <p className="text-gray-700 mb-3">
                  specialised heritage Queenslander restoration and Brisbane River flood expertise for New Farm's cultural district.
                </p>
                <div className="flex items-centre text-blue-600 font-medium group-hover:text-blue-700">
              ...
              >
                <div className="flex items-centre gap-3 mb-4">
                  <div className="w-12 h-12 bg-emerald-100 rounded-lg flex items-centre justify-centre group-hover:bg-emerald-200 transition-colors">
                ...
                <div className="flex items-centre text-emerald-600 font-medium group-hover:text-emerald-700">
                  <span>Learn More</span>
                  <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </div>
              </Link>
              ...
              >
                <div className="flex items-centre gap-3 mb-4">
                  <div className="w-12 h-12 bg-yellow-100 rounded-lg flex items-centre justify-centre group-hover:bg-yellow-200 transition-colors">
                ...
                <div className="flex items-centre text-yellow-600 font-medium group-hover:text-yellow-700">
                  <span>Learn More</span>
                  <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </div>
              </Link>
              ...
              >
                <div className="flex items-centre gap-3 mb-4">
                  <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-centre justify-centre group-hover:bg-purple-200 transition-colors">
                ...
                <div className="flex items-centre text-purple-600 font-medium group-hover:text-purple-700">
                  <span>Learn More</span>
                  <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </div>
              </Link>
              ...
              >
                <div className="flex items-centre gap-3 mb-4">
                  <div className="w-12 h-12 bg-teal-100 rounded-lg flex items-centre justify-centre group-hover:bg-teal-200 transition-colors">
                ...
                <div className="flex items-centre text-teal-600 font-medium group-hover:text-teal-700">
                  <span>Learn More</span>
                  <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </div>
              </Link>
              ...
              <div className="group bg-gradient-to-br from-gray-50 to-slate-50 rounded-xl p-6 border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all">
                <div className="flex items-centre gap-3 mb-4">
                  <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-centre justify-centre group-hover:bg-gray-200 transition-colors">
                ...
                <div className="flex items-centre text-gray-600 font-medium group-hover:text-gray-700">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-gray-600 mb-10 text-centre max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-blue-600 rounded-full flex items-centre justify-centre mr-4">
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-amber-100 rounded-xl p-6 border border-yellow-200">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-yellow-600 rounded-full flex items-centre justify-centre mr-4">
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl p-6 border border-green-200">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-green-600 rounded-full flex items-centre justify-centre mr-4">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-violet-100 rounded-xl p-6 border border-purple-200">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-purple-600 rounded-full flex items-centre justify-centre mr-4">
              ...
              <div className="bg-gradient-to-br from-red-50 to-rose-100 rounded-xl p-6 border border-red-200">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-red-600 rounded-full flex items-centre justify-centre mr-4">
              ...
              <div className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-xl p-6 border border-teal-200">
                <div className="flex items-centre mb-4">
                  <div className="w-12 h-12 bg-teal-600 rounded-full flex items-centre justify-centre mr-4">
                    <svg className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
                    </svg>
                  </div>
                ...
                <p className="text-gray-700">
                  Brisbane's 70-90% humidity requires specialised drying techniques. Our teams use thermal imaging and moisture meters to prevent mould growth in Brisbane's challenging climate conditions.
                </p>
              </div>
            </div>
            ...
            <div className="mt-12 bg-gradient-to-br from-red-600 to-red-800 text-white rounded-2xl p-8 shadow-xl">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 bg-yellow-400 text-gray-900 rounded-full flex items-centre justify-centre font-bold text-lg mr-4">
                    1
                  </div>
                  <div>
              ...
              <div className="mt-8 text-centre">
                <Link
                  href="tel:1300309361"
                  className="inline-flex items-centre justify-centre px-8 py-4 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold rounded-lg transition-colors text-lg"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="bg-white rounded-xl shadow-sm p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-centre">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-centre p-3 bg-gray-50 rounded-lg">
            ...
            <div className="bg-blue-900 text-white rounded-xl p-8 text-centre">
              ...
              <Link
                href="/insurance"
                className="inline-flex items-centre justify-centre px-8 py-3 bg-white text-blue-900 font-bold rounded-lg hover:bg-gray-100 transition-colors"
              >
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6">
                ...
                <p className="text-gray-600">
                  Yes. Our 24/7 emergency disaster recovery Brisbane service operates during severe weather events. We prioritise emergency callouts during Brisbane storm season (November-February) and have contingency plans for Brisbane River flooding based on Bureau of Meteorology warnings.
                </p>
              </div>
        ...
        <section className="py-16 bg-blue-900 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-centre">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-centre">
              <Link
                href="tel:1300309361"
                className="inline-flex items-centre justify-centre px-8 py-4 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg transition-colors text-xl"
              >
                <Phone className="mr-2 h-6 w-6" />
                1300 309 361
              </Link>
