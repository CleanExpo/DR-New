        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-gray-700">
                1-hour emergency response time across Brisbane, Ipswich and Logan
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-gray-700">
                24/7/365 emergency service including weekends and holidays
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
              ...
              <p className="text-gray-700">
                Service area within 50km radius of our Wacol headquarters
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-left max-w-2xl mx-auto">
              <div className="flex items-start">
                ...
                <span className="text-gray-700">Water extraction and drying</span>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 text-red-600 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div className="flex items-start">
                ...
                <span className="text-gray-700">Storm and flood response</span>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 text-red-600 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                <span className="text-gray-700">Sewage backup cleanup</span>
              </div>
              <div className="flex items-start">
                <svg className="w-5 h-5 text-red-600 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div className="flex items-start">
                ...
                <span className="text-gray-700">Biohazard cleaning</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
            ...
            <p className="text-gray-700 mb-4">
              IICRC certified technicians ready to respond immediately
            </p>
