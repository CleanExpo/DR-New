  ...
  if (variant === 'vertical') {
    return (
      <div className={`bg-white rounded-xl shadow-lg p-6 ${className}`}>
        <h3 className="font-bold text-lg mb-4 text-center">Why Trust Us</h3>
        ...
        {showRatings && (
          <div className="mb-6">
            ...
            <div className="bg-yellow-50 rounded-lg p-3">
              ...
              <p className="text-center text-sm font-semibold">4.9 out of 5</p>
              <p className="text-center text-xs text-gray-600">Based on 1,247 reviews</p>
            </div>
          </div>
        )}
            ...
            <div className="flex flex-wrap gap-2">
              {certifications.map((cert, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-1 bg-white rounded-full px-3 py-1 shadow-sm border"
                >
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="tel:1300000000"
              className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-4 py-2 rounded-full flex items-center gap-2 transition-colors"
            >
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
      {badges.map((badge, i) => (
        <motion.div
          ...
          transition={{ delay: i * 0.1 }}
          className="bg-white rounded-lg p-4 text-center border border-gray-200 hover:border-blue-500 hover:shadow-lg transition-all"
        >
