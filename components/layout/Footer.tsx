          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                <svg className="w-5 h-5 text-emergency-400 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <a href="tel:1300309361" className="text-white font-bold text-lg hover:text-primary-400 transition-colors">1300 309 361</a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <a href="mailto:admin@disasterrecovery.com.au" className="text-white hover:text-primary-400 transition-colors">admin@disasterrecovery.com.au</a>
                </div>
              </div>
