...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border-2 border-neutral-200 bg-white text-neutral-900 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 hover:border-primary-500",
      className
    )}
    {...props}
  />
