  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="icon" className="relative">
          ...
          {unreadCount > 0 && (
            <Badge
              variant="destructive"
              className="absolute -top-1 -right-1 h-5 w-5 flex items-centre justify-centre p-0 text-xs"
            >
      ...
      <DropdownMenuContent align="end" className="w-80">
        <div className="flex items-centre justify-between px-4 py-2 border-b">
        ...
        <ScrollArea className="h-[400px]">
          {loading && notifications.length === 0 ? (
            <div className="px-4 py-8 text-centre text-sm text-muted-foreground">
