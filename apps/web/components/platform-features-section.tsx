    ...
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-[#0F1115] p-6 rounded-2xl border border-[#374151]/50 hover:border-[#00BFA6]/50 transition-[border-color] duration-300 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)]">
