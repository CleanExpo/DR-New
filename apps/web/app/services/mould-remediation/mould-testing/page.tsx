...
export const metadata: Metadata = {
  ...
  description:
    "NATA-accredited mould testing and laboratory analysis. Air spore sampling, surface testing, species identification, and court-admissible reports across Australia.",
}
