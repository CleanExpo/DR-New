...
export const metadata: Metadata = {
  ...
  description:
    "Professional methamphetamine laboratory decontamination and remediation. Certified to Australian Clandestine Drug Laboratory Remediation Guidelines. NATA-accredited testing across Australia.",
}
