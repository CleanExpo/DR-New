    ...
    <div className="min-h-screen bg-[#050505]">
      ...
      <div className="border-b border-white/10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link
            href="/store"
            className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-white/40 hover:text-teal-400 transition-[color] duration-200 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)]"
          >
          ...
          >
                  ...
                  {product.variants.map((variant) => {
                    ...
                    return (
                      <button
                        ...
                        className={`text-sm font-semibold px-4 py-2 rounded-sm border transition-[background-color,border-color,color,box-shadow] duration-200 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)] min-w-[3rem] ${
                          !variant.inStock
            ...
            <div>
              ...
              <div className="flex items-center gap-0 border border-white/20 rounded-sm w-fit">
                <button
                  ...
                  disabled={quantity <= 1}
                  className="w-10 h-10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/5 disabled:opacity-30 disabled:cursor-not-allowed transition-[background-color,color] duration-150 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)] border-r border-white/10"
                >
                ...
                <button
                  ...
                  className="w-10 h-10 flex items-center justify-center text-white/60 hover:text-white hover:bg-white/5 disabled:opacity-30 disabled:cursor-not-allowed transition-[background-color,color] duration-150 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)] border-l border-white/10"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {hydrated && itemCount > 0 && (
              ...
              >
                <Link
                  href="/store/cart"
                  className="flex items-center justify-center gap-2 w-full py-3 rounded-sm text-[11px] font-black uppercase tracking-widest text-teal-400 border border-teal-500/30 hover:bg-teal-500/5 transition-[background-color] duration-200 [transition-timing-function:cubic-bezier(0.4,0,0.2,1)]"
                >
