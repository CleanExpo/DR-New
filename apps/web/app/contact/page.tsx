...
export const metadata: Metadata = {
  title: 'Contact Us | Disaster Recovery Australia',
  description: 'Contact Disaster Recovery Australia for emergency restoration services. 24/7 support via our online portal. IICRC-certified contractors matched within minutes.',
  alternates: { canonical: 'https://disasterrecovery.com.au/contact' },
}
