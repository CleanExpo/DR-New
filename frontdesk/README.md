...
NRPG's instance of the portfolio **AI Front Desk** — a single agent "brain"
...
- **This desk's job:** Membership and directory-listing enquiries plus member support for the National Restoration Professionals Group.
- **Lead channel:** web chat (then phone)
- **Stack it plugs into:** Node (confirm framework)
...
3. Set `NRPG_FRONT_DESK_ENABLED=true` in the environment to enable; unset/false = fully dark.
