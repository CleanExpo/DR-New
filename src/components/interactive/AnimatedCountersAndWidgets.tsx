...
function ResponseTimeMap(...args: any[]): void {
  const locations = [
    ...
    { city: 'Brisbane', time: 48, colour: 'from-blue-700 to-yellow-600', lat: -27.4698, lng: 153.0251 },
    { city: 'Perth', time: 55, colour: 'from-blue-700 to-yellow-600', lat: -31.9505, lng: 115.8605 },
  ];
...
export default function AnimatedCountersAndWidgets() {
  ...
  const stats = [
      ...
      delay: 0.4 },
    {
      ...
      colour: 'from-blue-700 to-yellow-600',
      delay: 0.6 },
  ];
