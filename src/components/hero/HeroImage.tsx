        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            {ctaText && ctaLink && (
              <motion.a
                href={ctaLink}
                className="inline-block bg-blue-700 hover:bg-blue-800 text-white font-bold py-4 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
